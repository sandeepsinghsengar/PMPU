...
from mpunet.utils.training_utils import ce_loss, he_normal
...
def down_block(features,
    ...
    for _ in range(num_convs):
      features = Conv2D(output_channels, kernel_shape, stride, rate, data_format=data_format,
...
class AxisAlignedConvGaussian(Model):
    ...
    def _build(self, img, seg=None):
        ...
        mu_log_sigma = Conv2D(2 * self._latent_dim, (1,1), stride=1, rate=1, data_format=self._data_format,
